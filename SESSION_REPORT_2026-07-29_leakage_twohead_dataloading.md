...
## ★★0b. L48 初步翻转(2026-07-30, 单种子, 种子复核中)—— 可能改写全局
**human L24→L48 重建 + 干净 episode-split 后, 两个 L24 负结论都翻了**(同一 mp):
| mp 全量 | ro | rh_single | rh_two | human帮 | two-head帮 |
|---|---|---|---|---|---|
| L24(leaky) | 2.083 | 2.318 | 2.314 | −0.235 害 | ~0 无效 |
| **L48(clean)** | **2.196** | **2.111** | **2.072** | **+0.085 帮** | **+0.039 帮** |
稀缺 n100 human帮 +4.90(强, 一致)。→ **强烈指向 L24 短切片(+泄漏)制造了假负结论; L48 对齐长度后 human 全量都帮、两头也帮。**
⚠️**Δ小(+0.085/+0.039)、单种子**; seed1/2 复核中(mp_r/rh/rh_two_all_s1,s2), 稳=重大结论(short-clip 是 human 弱根因), 横跳=噪声。别过早写死。
