...
OUT = "outputs/flow_wm/densev4d_maskgen_joint2mask_v3"; os.makedirs(OUT, exist_ok=True)
...
print(f"HELD-OUT (video3) mean IoU = {np.mean(ious):.3f}  (v2 robot_v3-sup=0.647; new sup=robot_arm_mask)", flush=True)
